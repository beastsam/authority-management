...
/**
 * Servlet implementation class UploadIndividual
 * @author: beastsam
 * @date: 2018.8.21
 * @Description:
 ...
 */
@WebServlet("/UploadIndividual")
public class UploadIndividual extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            factory.setSizeThreshold(1024 * 1024 * 3);//设置缓冲区的大小为3M，如果不指定，那么缓冲区的大小默认是10KB
            //设置上传时生成的临时文件的保存目录
            ...
            request.getRequestDispatcher("/individual_upload_message.jsp").forward(request, response);
            return;
        ...
        try {
        	...
        	int iRateId = Integer.valueOf(info[0]).intValue() + Integer.valueOf(info[1]).intValue();
        	String sRateId = String.valueOf(iRateId);
 			dbControl.insertRate(info[0], sRateId);
 			 request.setAttribute("rateId",sRateId);
        	} catch(Exception e){
        		e.printStackTrace(); 
        	}	      
